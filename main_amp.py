...
train_sequence = pd.read_csv('data/ACP_dataset/tsv/amp_train.csv',sep='\t')['text'].tolist()
test_sequence = pd.read_csv('data/ACP_dataset/tsv/amp_test.csv',sep='\t')['text'].tolist()

train_label = pd.read_csv('data/ACP_dataset/tsv/amp_train.csv',sep='\t')['label'].tolist()
test_label = pd.read_csv('data/ACP_dataset/tsv/amp_test.csv',sep='\t')['label'].tolist()
...
integrated_model.pretrained_model.save_pretrained('finetune_peptide_model')